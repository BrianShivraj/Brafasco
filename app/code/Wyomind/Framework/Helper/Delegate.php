 ...
 */
namespace Wyomind\Framework\Helper;  class Delegate extends \Wyomind\Framework\Helper\License {public $x217b8=null;public $x11579=null;public $xbe532=null; const VERSION = "\65.\62\56\71"; public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, \Magento\Framework\App\Helper\Context $context) { parent::__construct($objectManager, $context); $this->constructor($this, func_get_args(), __CLASS__); } protected function getDelegation() { ${$this->x11579->x4aeb->{$this->x11579->x4aeb->{$this->xbe532->x4aeb->x6bb2}}} = "\\"; return [ ]; } }